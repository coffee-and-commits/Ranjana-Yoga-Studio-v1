  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      ...
      <a
        ...
        aria-label="WhatsApp"
        className="group w-12 h-12 flex items-center justify-center rounded-full bg-[#25D366]/15 backdrop-blur-md border border-[#25D366]/40 shadow-lg transition-all duration-300 hover:bg-[#25D366] hover:scale-125 hover:shadow-[#25D366]/40 hover:shadow-xl cursor-pointer"
      >
        <svg viewBox="0 0 24 24" className="w-5 h-5 fill-[#25D366] group-hover:fill-white transition-colors duration-300" xmlns="http://www.w3.org/2000/svg">
      ...
      <a
        ...
        className="group w-12 h-12 flex items-center justify-center rounded-full bg-[#E1306C]/15 backdrop-blur-md border border-[#E1306C]/40 shadow-lg transition-all duration-300 hover:bg-gradient-to-br hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#833ab4] hover:scale-125 hover:shadow-[#E1306C]/40 hover:shadow-xl !cursor-pointer"
      >
        <svg viewBox="0 0 24 24" className="w-5 h-5 fill-[#E1306C] group-hover:fill-white transition-colors duration-300" xmlns="http://www.w3.org/2000/svg">
